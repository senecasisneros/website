...
class Portfolio extends React.Component {
  render() {
    ...
    <Grid className="Portfolio">
      ...
      <p className="textPort">Search for a resturant by location and this app will return a random restuarant with its rating, contact information, curent weather and the map of the location. (This was a collaboration with 3 other developers)</p>
          <ul className="port-icons">
            <li className="portLi">
